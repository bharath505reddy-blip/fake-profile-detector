...
def enrich(user_id_or_username: str, manual_data: Optional[Dict] = None) -> Dict:
    ...
    return {
        "platform": "discord",
        "username": username,
        "name": raw.get("global_name") or raw.get("display_name") or username,
        "followers": None,
        "following": None,
        "posts": None,
        "bio": raw.get("bio", ""),
        ...
        "avatar_url": f"https://cdn.discordapp.com/avatars/{raw.get('id')}/{raw.get('avatar')}.png" if raw.get('avatar') and raw.get('id') else None,
